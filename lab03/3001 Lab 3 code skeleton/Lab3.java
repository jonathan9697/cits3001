    ...
    public static void main(String[] args) 
    {
        try
        {
            ...
            for (File file : new File(tsptestdata).listFiles()) 
                ...
                {
                    //prints filename to outTSP.txt
                    out.println(file.getName());
                    // creates new TSP object using test file location
                    tsp = new TSP(tsptestdata + "/" + file.getName());
                    //calls tspnn function in tsp object
                    //tspnn returns the shortest tour
                    int[] cs = tsp.tspnn(); // cs = shortest tour
                    // prints "Nearest neighbour" + shortest tour to outTSP.txt
